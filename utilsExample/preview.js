...
const buildDir = `PUBLIC_USER_FOLDER/build`;

const { preview } = require(`PUBLIC_USER_FOLDER/config.js`);

// read json data
const rawdata = fs.readFileSync(`PUBLIC_USER_FOLDER/build/json/_metadata.json`);
